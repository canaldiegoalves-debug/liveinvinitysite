    ...
    hub.innerHTML = `
      ...
      <div id="lic-body" style="padding:14px;display:flex;flex-direction:column;gap:12px;overflow-y:auto;overflow-x:hidden;max-height:calc(85vh - 54px);scrollbar-width:thin;scrollbar-color:rgba(255,208,0,0.35) transparent;">
        ...
        <div style="display:flex;align-items:center;justify-content:space-between;background:#0d111d;border:1px solid rgba(255,208,0,0.2);border-radius:12px;padding:12px 14px;">
          ...
          <button id="lic-btn-audio-toggle" style="padding:5px 12px;border-radius:999px;border:1px solid rgba(255,255,255,0.15);background:rgba(        <!-- MÓDULO VB-CABLE COMPLETO (5 CARDS LIVEFLOW COM IDENTIDADE LIVECAM & COLLAPSE) -->
        ...
        </div>a;border:1px solid rgba(255,255,255,0.1);border-radius:8px;padding:8px 10px;font-family:monospace;font-size:10px;color:#00e5ff;height:45px;overflow-y:auto;">- Nenhum evento ainda</div>
          </div>
